...
<template>
  <div class="px-4 sm:px-6 lg:px-8">
    ...
    <!-- Divider -->
    <hr class="my-4 sm:my-6 border-t-4 border-deep-blue" />
    ...
    >
      <!-- Copyright text -->
      <p
        class="text-gray-600 dark:text-gray-400 text-xs sm:text-sm text-center sm:text-left order-2 sm:order-1"
      >
